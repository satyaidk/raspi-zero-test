...
def speak_text(text_to_speak):
    ...
    try:
        ...
        # Play the MP3 using mpg321 (which we verified works with your I2S setup)
    ...
    with sr.Microphone() as source:
        try:
            ...
            response = ai_client.models.generate_content(
                ...
                contents=user_text,
                # Giving a system instruction keeps replies short and ideal for an audio speaker
...
print("==================================================")
print("Smart AI Assistant Online & Ready!")
